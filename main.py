...
def main(serialize=True, name=None):
    ...
    for i in range(100):
        ...
        experiment[PREY_ATTRS_NAME]["sight_range"] = int((min(experiment[ENV_PARAMS_NAME]["screen_width"], experiment[ENV_PARAMS_NAME]["screen_height"]) * (2.0 / 3.0)) - max(experiment[PREY_ATTRS_NAME]["size"], experiment[PREDATOR_ATTRS_NAME]["size"]))
