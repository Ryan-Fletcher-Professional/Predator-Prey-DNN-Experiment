...
INPUT_DIM = len(DEFAULT_SELF_INPUTS) + (len(DEFAULT_OTHER_INPUTS) * DEFAULT_ENVIRONMENT_PARAMETERS["num_predators"])

# Use for CreatureFullyConnectedShallow class
DIMS_FOR_SHALLOW_EXP_1 = [INPUT_DIM, DEFAULT_OUTPUT_DIM, DEFAULT_OUTPUT_DIM]
DIMS_FOR_SHALLOW_EXP_2 = [INPUT_DIM, int(INPUT_DIM/4), DEFAULT_OUTPUT_DIM]
DIMS_FOR_SHALLOW_EXP_3 = [INPUT_DIM, int(INPUT_DIM/2), DEFAULT_OUTPUT_DIM]
DIMS_FOR_SHALLOW_EXP_4 = [INPUT_DIM, int(3*INPUT_DIM/4), DEFAULT_OUTPUT_DIM]
DIMS_FOR_SHALLOW_EXP_5 = [INPUT_DIM, INPUT_DIM, DEFAULT_OUTPUT_DIM]
DIMS_FOR_SHALLOW_EXP_6 = [INPUT_DIM, 2*INPUT_DIM, DEFAULT_OUTPUT_DIM]

# Use for CreatureFullyConnected class
DIMS_FOR_FCN_EXP_1 = [INPUT_DIM, int(3*INPUT_DIM/2), INPUT_DIM, int(INPUT_DIM/2), DEFAULT_OUTPUT_DIM]
DIMS_FOR_FCN_EXP_2 = [INPUT_DIM, int(INPUT_DIM/2), int(INPUT_DIM/4), int(INPUT_DIM/8), DEFAULT_OUTPUT_DIM]
DIMS_FOR_FCN_EXP_3 = [INPUT_DIM, INPUT_DIM, INPUT_DIM, INPUT_DIM, DEFAULT_OUTPUT_DIM]
DIMS_FOR_FCN_EXP_4 = [INPUT_DIM, int(5*INPUT_DIM/4), int(6*INPUT_DIM/4), int(7*INPUT_DIM/4), DEFAULT_OUTPUT_DIM]
DIMS_FOR_FCN_EXP_5 = [INPUT_DIM, INPUT_DIM, int(INPUT_DIM/2), INPUT_DIM, DEFAULT_OUTPUT_DIM]
DIMS_FOR_FCN_EXP_6 = [INPUT_DIM, int(INPUT_DIM/2), int(3*INPUT_DIM/2), int(INPUT_DIM/2), DEFAULT_OUTPUT_DIM]

# Use for CreatureDeepWithDropOut class
DIMS_FOR_DEEP_FCN_EXP_1 = [INPUT_DIM, int(6*INPUT_DIM/7), int(5*INPUT_DIM/7), int(4*INPUT_DIM/7), int(3*INPUT_DIM/7), int(2*INPUT_DIM/7), int(1*INPUT_DIM/7), DEFAULT_OUTPUT_DIM]
DIMS_FOR_DEEP_FCN_EXP_2 = [INPUT_DIM, int(5*INPUT_DIM/4), int(6*INPUT_DIM/4), int(7*INPUT_DIM/4), int(6*INPUT_DIM/4), int(3*INPUT_DIM/4), int(1*INPUT_DIM/4), DEFAULT_OUTPUT_DIM]
DIMS_FOR_DEEP_FCN_EXP_3 = [INPUT_DIM, int(3*INPUT_DIM/4), int(3*INPUT_DIM/4), int(3*INPUT_DIM/4), int(3*INPUT_DIM/4), int(3*INPUT_DIM/4), int(3*INPUT_DIM/4), DEFAULT_OUTPUT_DIM]
DIMS_FOR_DEEP_FCN_EXP_4 = [INPUT_DIM, int(1*INPUT_DIM/7), int(2*INPUT_DIM/7), int(3*INPUT_DIM/7), int(4*INPUT_DIM/7), int(5*INPUT_DIM/7), int(6*INPUT_DIM/7), DEFAULT_OUTPUT_DIM]
DIMS_FOR_DEEP_FCN_EXP_5 = [INPUT_DIM] + [int((7-i)*INPUT_DIM/7) for i in range(1, 7)] + [DEFAULT_OUTPUT_DIM]
DIMS_FOR_DEEP_FCN_EXP_6 = [INPUT_DIM] + [int(i*INPUT_DIM/7) for i in range(1, 7)] + [DEFAULT_OUTPUT_DIM]

# Use for CreatureVeryDeepFullyConnected AND CreatureVeryDeepFullyConnectedWithDropout classes
DIMS_FOR_VERY_DEEP_FCN_EXP_1 = [INPUT_DIM] + [int(i*INPUT_DIM/30) for i in range(1, 30)] + [DEFAULT_OUTPUT_DIM]
DIMS_FOR_VERY_DEEP_FCN_EXP_2 = [INPUT_DIM] + [INPUT_DIM - int(i*INPUT_DIM/30) for i in range(1, 30)] + [DEFAULT_OUTPUT_DIM]
DIMS_FOR_VERY_DEEP_FCN_EXP_3 = [INPUT_DIM] + [int((i % 2 + 1) * INPUT_DIM/2) for i in range(1, 30)] + [DEFAULT_OUTPUT_DIM]
DIMS_FOR_VERY_DEEP_FCN_EXP_4 = [INPUT_DIM] + [int((30 - i) * INPUT_DIM/30) for i in range(1, 30)] + [DEFAULT_OUTPUT_DIM]
DIMS_FOR_VERY_DEEP_FCN_EXP_5 = [INPUT_DIM] + [int((i % 3 + 1) * INPUT_DIM/3) for i in range(1, 30)] + [DEFAULT_OUTPUT_DIM]
DIMS_FOR_VERY_DEEP_FCN_EXP_6 = [INPUT_DIM] + [INPUT_DIM if i % 2 == 0 else int(INPUT_DIM/2) for i in range(1, 30)] + [DEFAULT_OUTPUT_DIM]
...
DEFAULT_PREY_NETWORK_HYPERPARAMETERS = {
    ...
    "dimensions"    : DIMS_FOR_SHALLOW_EXP_1,  #[len(DEFAULT_SELF_INPUTS) + (len(DEFAULT_OTHER_INPUTS) * DEFAULT_ENVIRONMENT_PARAMETERS["num_predators"]), 32, 16, 8, DEFAULT_OUTPUT_DIM],
    "print_state"   : False,
    "print_loss"    : False,
...
DEFAULT_PREDATOR_NETWORK_HYPERPARAMETERS = {
    "input_keys"    : (DEFAULT_SELF_INPUTS, DEFAULT_OTHER_INPUTS),
    "dimensions"    : DIMS_FOR_SHALLOW_EXP_1,  #[len(DEFAULT_SELF_INPUTS) + (len(DEFAULT_OTHER_INPUTS) * DEFAULT_ENVIRONMENT_PARAMETERS["num_preys"]), 32, 16, 8, DEFAULT_OUTPUT_DIM],
    "print_state"   : False,
    "print_loss"    : False,
}
