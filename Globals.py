...
DIMS_FOR_VERY_DEEP_FCN_EXP_1 = [INPUT_DIM] + [int(i*INPUT_DIM/30) for i in range(1, 31)] + [DEFAULT_OUTPUT_DIM]
DIMS_FOR_VERY_DEEP_FCN_EXP_2 = [INPUT_DIM] + [INPUT_DIM - int(i*INPUT_DIM/30) for i in range(1, 31)] + [DEFAULT_OUTPUT_DIM]
DIMS_FOR_VERY_DEEP_FCN_EXP_3 = [INPUT_DIM] + [int((i % 2 + 1) * INPUT_DIM/2) for i in range(1, 31)] + [DEFAULT_OUTPUT_DIM]
DIMS_FOR_VERY_DEEP_FCN_EXP_4 = [INPUT_DIM] + [int((30 - i) * INPUT_DIM/30) for i in range(1, 31)] + [DEFAULT_OUTPUT_DIM]
DIMS_FOR_VERY_DEEP_FCN_EXP_5 = [INPUT_DIM] + [int((i % 3 + 1) * INPUT_DIM/3) for i in range(1, 31)] + [DEFAULT_OUTPUT_DIM]
DIMS_FOR_VERY_DEEP_FCN_EXP_6 = [INPUT_DIM] + [INPUT_DIM if i % 2 == 0 else int(INPUT_DIM/2) for i in range(1, 31)] + [DEFAULT_OUTPUT_DIM]
...
DEFAULT_PREY_NETWORK_HYPERPARAMETERS = {
    ...
    "dimensions"    : DIMS_FOR_SHALLOW_EXP_5,  #[len(DEFAULT_SELF_INPUTS) + (len(DEFAULT_OTHER_INPUTS) * DEFAULT_ENVIRONMENT_PARAMETERS["num_predators"]), 32, 16, 8, DEFAULT_OUTPUT_DIM],
    "print_state"   : False,
    "print_loss"    : False,
...
DEFAULT_PREDATOR_NETWORK_HYPERPARAMETERS = {
    "input_keys"    : (DEFAULT_SELF_INPUTS, DEFAULT_OTHER_INPUTS),
    "dimensions"    : DIMS_FOR_SHALLOW_EXP_5,  #[len(DEFAULT_SELF_INPUTS) + (len(DEFAULT_OTHER_INPUTS) * DEFAULT_ENVIRONMENT_PARAMETERS["num_preys"]), 32, 16, 8, DEFAULT_OUTPUT_DIM],
    "print_state"   : False,
    "print_loss"    : False,
}
